defmodule CgratesWebJsonapi.TariffPlans.TpActionTrigger do
  use Ecto.Schema
  ...
  def threshold_types,
    do:
      ~w[*min_counter *max_counter *min_balance *max_balance *min_asr *max_asr *min_acd
  ...
  def changeset(struct, params \\ %{}) do
    ...
    |> unique_constraint(:tag,
      name: :tp_action_triggers_tpid_tag_balance_tag_balance_type_balanc_key
    )
  end
end
