defmodule CgratesWebJsonapi.TpAliasImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-aliases.csv"}

      conn = post(conn, tp_alias_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_alias_import_job",
