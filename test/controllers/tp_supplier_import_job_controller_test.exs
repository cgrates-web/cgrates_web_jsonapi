defmodule CgratesWebJsonapi.TpSupplierImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-suppliers.csv"}

      conn = post(conn, tp_supplier_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_supplier_import_job",
