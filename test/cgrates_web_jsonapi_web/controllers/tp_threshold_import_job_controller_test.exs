defmodule CgratesWebJsonapi.TariffPlans.TpThresholdImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-thresholds.csv"}

      conn = post(conn, Routes.tp_threshold_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_threshold_import_job",
