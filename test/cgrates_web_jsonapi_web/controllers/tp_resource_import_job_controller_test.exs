defmodule CgratesWebJsonapi.TariffPlans.TpResourceImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-resources.csv"}

      conn = post(conn, Routes.tp_resource_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_resource_import_job",
