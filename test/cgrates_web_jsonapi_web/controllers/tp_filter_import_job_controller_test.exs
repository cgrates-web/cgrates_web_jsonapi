defmodule CgratesWebJsonapi.TariffPlans.TpFilterImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-filters.csv"}

      conn = post(conn, Routes.tp_filter_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_filter_import_job",
