defmodule CgratesWebJsonapi.TariffPlans.TpChargerImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-chargers.csv"}

      conn = post(conn, Routes.tp_charger_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_charger_import_job",
