defmodule CgratesWebJsonapiWeb.CdrControllerTest do
  ...
  describe "GET index" do
    ...
    test "filtering by cgrid", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{cgrid: cdr1.cgrid})
      |> doc()
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by run_id", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{run_id: cdr1.run_id})
      |> doc()
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by origin_host", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{origin_host: cdr1.origin_host})
      |> doc()
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by source", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{source: cdr1.source})
      |> doc(())
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by origin_id", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{origin_id: cdr1.origin_id})
      |> doc
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by tor", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{tor: cdr1.tor})
      |> doc
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by tenant", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{tenant: cdr1.tenant})
      |> doc
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by category", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{category: cdr1.category})
      |> doc
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by account", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{account: cdr1.account})
      |> doc
      assert length(json_response(conn, 200)["data"]) == 1
    end
    ...
    test "filtering by destination", %{conn: conn} do
      ...
      conn = get(conn, Routes.cdr_path(conn, :index), filter: %{destination: cdr1.destination})
      |> doc
      assert length(json_response(conn, 200)["data"]) == 1
    end
  end
