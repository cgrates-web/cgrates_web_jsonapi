defmodule CgratesWebJsonapi.TariffPlans.TpActionImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-actions.csv"}

      conn = post(conn, Routes.tp_action_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_action_import_job",
