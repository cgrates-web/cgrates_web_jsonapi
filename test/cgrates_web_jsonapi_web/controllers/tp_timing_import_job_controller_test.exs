defmodule CgratesWebJsonapi.TariffPlans.TpTimingImportJobControllerTest do
  ...
  describe "POST create" do
    test "creates resource imported from csv file", %{conn: conn} do
      ...
      csv = %Plug.Upload{path: path, filename: "tp-timings.csv"}

      conn = post(conn, Routes.tp_timing_import_job_path(conn, :create), %{
        "meta" => %{},
        "data" => %{
          "type" => "tp_timing_import_job",
