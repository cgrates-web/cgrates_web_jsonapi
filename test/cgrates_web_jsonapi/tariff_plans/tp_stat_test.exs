defmodule CgratesWebJsonapi.TariffPlans.TpStatTest do
  ...
  @valid_attrs %{
    ...
    min_items: 2,
    stored: false,
    supplier_resource_ids: "some content",
    queue_length: 2,
    ...
    custom_id: "1",
    blocker: false,
    metric_ids: "some content",
    metric_filter_ids: "some content"
  }
  @invalid_attrs %{}
  ...
  describe "#from_csv" do
    test "it parses csv and inserts records to DB" do
      ...
      assert TpStat |> Repo.aggregate(:count, :pk) == 1
