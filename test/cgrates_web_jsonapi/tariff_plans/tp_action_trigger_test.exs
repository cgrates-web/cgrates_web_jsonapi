defmodule CgratesWebJsonapi.TariffPlans.TpActionTriggerTest do
  ...
  @valid_attrs %{
    ...
    balance_weight: "10",
    min_sleep: "content",
    balance_categories: "some content",
    balance_destination_tags: "some content",
    expiry_time: "20s",
    actions_tag: "some content",
    recurrent: "false",
    activation_time: "20s",
    balance_expiry_time: "some content",
    threshold_type: "*min_counter",
    balance_rating_subject: "some content",
    balance_shared_groups: "some content",
    tag: "some content",
    balance_timing_tags: "some content",
    tpid: "some content",
    threshold_value: "4.0",
    weight: "120.5"
  }
