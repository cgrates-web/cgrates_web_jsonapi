defmodule CgratesWebJsonapi.TpAccountActionTest do
  ...
  @valid_attrs %{ allow_negative: "true", disabled: "false", loadid: "some content",
                  tenant: "some content", action_triggers_tag: "10",
                  account: "some content", action_plan_tag: "some content", tpid: "some content" }
