defmodule CgratesWebJsonapi.TpResourceTest do
  ...
  @valid_attrs %{tenant: "some content", custom_id: "true", usage_ttl: "some content",
                 filter_ids: "some content", activation_interval: "some content", threshold_ids: "some content",
                 limit: "some content", allocation_message: "some content", stored: false, blocker: false,
