defmodule CgratesWebJsonapi.CdrTest do
  ...
  @valid_attrs %{account: "some content", account_summary: "some content",
                 answer_time: %{day: 17, hour: 14, min: 0, month: 4, sec: 0, year: 2010}, category: "some content",
                 cgrid: "some content", cost: "120.5", cost_details: "some content", cost_source: "some content",
                 destination: "some content", direction: "some content", disconnect_cause: "some content",
                 extra_fields: "some content", extra_info: "some content", origin_host: "some content",
