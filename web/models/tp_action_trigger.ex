defmodule CgratesWebJsonapi.TpActionTrigger do
  ...
  @attributes ~w[tpid tag unique_id balance_tag balance_type threshold_type threshold_value expiry_time
                 balance_directions balance_destination_tags balance_rating_subject balance_categories
                 balance_shared_groups balance_weight balance_blocker actions_tag min_sleep activation_time
                 balance_expiry_time balance_timing_tags balance_disabled recurrent min_queued_items weight]a
  ...
  def balance_directions, do: ~w[*in *out]
  ...
  schema "tp_action_triggers" do
    ...
    field :balance_directions, :string
  ...
  def changeset(struct, params \\ %{}) do
    ...
    |> validate_length(:balance_directions, max: 8)
    ...
    |> validate_inclusion(:balance_directions, balance_directions)
