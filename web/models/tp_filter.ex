defmodule CgratesWebJsonapi.TpFilter do
  ...
  def changeset(struct, params \\ %{}) do
    struct
    |> cast(params, [:tpid, :tenant, :id, :filter_type, :filter_field_name, :filter_field_values, :activation_interval])
    |> validate_required([:tpid, :tenant, :id, :filter_type, :filter_field_values])
